...
export default class AjusteDetailsScreen extends React.Component {
  render() {
    const {ajuste} = this.props.navigation.state.params;
    return (
      <View style={styles.pontoStyle}>
        ...
        <View>
          <Text style={styles.textStyle}>Código: {ajuste.code}</Text>

          <Text style={styles.textStyle}>
            Data: {moment(ajuste.date).format('DD/MM/YYYY hh:mma')}
          </Text>
